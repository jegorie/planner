...
const Item = ({
  ...
  const colorsMap = {
    ...
    green:
      "text-green-card bg-green-card-foreground hover:bg-green-card-action",
    orange:
      "text-orange-card bg-orange-card-foreground hover:bg-orange-card-action",
    purple:
      "text-purple-card bg-purple-card-foreground hover:bg-purple-card-action",
  } as const;
